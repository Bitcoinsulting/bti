...
#if defined(NDEBUG)
# error "BTICurrency cannot be compiled without assertions."
#endif
...
unsigned int nStakeMinAge = 60 * 24; // 8 min
...
const string strMessageMagic = "BTICurrency Signed Message:\n";
...
#ifdef ENABLE_WALLET
// BTICurrency: attempt to generate suitable proof-of-stake
...
{
    RenameThread("BTICurrency-loadblk");
